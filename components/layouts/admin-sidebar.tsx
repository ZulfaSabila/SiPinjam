...
>>>>>>> 95064e54 (init: setup project and add authorization checks)
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-40 h-screen bg-gradient-to-b from-[var(--admin-primary-dark)] to-[var(--admin-primary)] text-white transition-all duration-300 ease-in-out lg:translate-x-0 flex flex-col",
